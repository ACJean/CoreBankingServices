...
- __CustomerProfileService__: Este microservicio se encarga de gestionar datos del client, permitiendo operaciones como creación, actualización y eliminación. Utiliza una base de datos MSSQL para almacenar la información de los clientes.
...
- __Interacción entre Microservicios__: Los microservicios utilizan HTTP para comunicarse entre sí. Por ejemplo, al crear una cuenta en el *AccountTransactionService*, se verifica primero la existencia del cliente en el *CustomerProfileService*.
...
- Ejecutar script de base de datos en MSSQL ```BaseDatos.sql```
